...
function _rebuildPagesSidebar() {
    ...
    // أعد إلحاق زر "صفحة جديدة" في النهاية
...
function addPageToSidebar() {
    ...
    console.log(`تمت إضافة الصفحة ${pages.length} إلى الشريط الجانبي`);
}
...
function deletePage(pageIndex) {
    ...
    // نعيد بناء القائمة كاملاً من مصفوفة pages لضمان التزامن
    _rebuildPagesSidebar();
