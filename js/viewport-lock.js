...
(function () {
    ...
    document.addEventListener('wheel', function (e) {
        ...
        // موقع المؤشر نسبةً للحاوية (مع الـ scroll الحالي)
        ...
        page.scale     = Math.max(0.2, Math.min(oldScale * factor, 5));

        if (typeof applyTransform === 'function') applyTransform(page);

        // اضبط scroll بعد applyTransform حتى يبقى المؤشر فوق نفس النقطة
